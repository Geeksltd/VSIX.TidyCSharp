...
public class CSharpSyntaxRewriterBase : CleanupCSharpSyntaxRewriter
{
    ...
    private SyntaxTriviaList CleanUpList(SyntaxTriviaList newList, CleanupTypes? option = null)
    {
    ...
    private SyntaxTriviaList CleanUpList(SyntaxTriviaList syntaxTrivias, int exactNumberOfBlanks)
    {
    ...
    private SyntaxTriviaList Insert_Space_Before_Comment_Text(SyntaxTriviaList syntaxTrivias, SyntaxTrivia currentTrivia)
    {
        if (CheckOption((int)CleanupTypes.InsertSpaceBeforeCommentText))
        {
    ...
    private bool CheckShortSyntax(SyntaxTriviaList syntaxTrivias, bool itsForCloseBrace)
    {
    ...
    private int RemoveBlankDuplication(SyntaxTriviaList syntaxTrivias, SyntaxKind kind, int iterationIndex)
    {
