...
namespace Geeks.VSIX.TidyCSharp.Cleanup.NormalizeWhitespace
{
    ...
    public enum CleanupTypes
    {
        ...
        [CleanupItem(FirstOrder = 1, Title = "Remove duplicate blank lines between namespace members")]
        Remove_DBL_Between_Namespace_Members = 0x04,

        [CleanupItem(FirstOrder = 1, Title = "Remove duplicate blank lines between class members")]
        Remove_DBL_Between_Class_Members = 0x02,

        [CleanupItem(FirstOrder = 1, Title = "Remove duplicate blank lines between method statement")]
        Remove_DBL_Between_Methods_Statements = 0x01,

        [CleanupItem(FirstOrder = 1, Title = "Remove duplicate blank lines between comments")]
        Remove_DBL_Inside_Comments = 0x08,

        [CleanupItem(FirstOrder = 1, Title = "Remove duplicate blank lines between \"Usings ..\"")]
        Remove_DBL_Inside_Usings = 0x10,

        [CleanupItem(FirstOrder = 1, Title = "Remove blank lines before and after \"{\" and \"}\" of blocks")]
        ...
        /// </summary>
        [CleanupItem(FirstOrder = 1, Title = "Insert space before comment text : \\\\TODO: => \\\\ TODO:")]
        Insert_Space_Before_Comment_Text = 0x40,

        [CleanupItem(FirstOrder = 1, Title = "")]
